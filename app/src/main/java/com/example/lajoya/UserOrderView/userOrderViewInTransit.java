...
public class userOrderViewInTransit extends AppCompatActivity {
    ...
    protected void onStart(){
        ...
        FirebaseRecyclerOptions<UserOrders> options =
                new FirebaseRecyclerOptions.Builder<UserOrders>()
                        .setQuery(UserordersRef.child(Prevalent.currentOnlineUser.getPhone()).orderByChild("state").equalTo("In Transit"), UserOrders.class)
                        .build();
                    ...
                    protected void onBindViewHolder(@NonNull final UserOrdersViewHolder holder, final int position, @NonNull final UserOrders model) {
                        ...
                        holder.btnShow.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(userOrderViewInTransit.this, AdminUserProductsActivity.class);
