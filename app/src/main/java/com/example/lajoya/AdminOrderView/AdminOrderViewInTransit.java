...
public class AdminOrderViewInTransit  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderViewHead.setText("In Transit Orders");
    ...
    protected void onStart(){
        ...
        FirebaseRecyclerOptions<AdminOrders> options =
                new FirebaseRecyclerOptions.Builder<AdminOrders>()
                        .setQuery(ordersRef.orderByChild("state").equalTo("In Transit"), AdminOrders.class)
                        .build();
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull final AdminOrdersViewHolder holder, final int position, @NonNull final AdminOrders model) {
                        ...
                        holder.radioInTransit.setChecked(true);
                        ...
                        holder.ShowOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(AdminOrderViewInTransit.this, AdminUserProductsActivity.class);
